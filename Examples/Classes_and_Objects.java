...
This program simply allows the end user to enter 3 different employee's data, and then it displays said data.
This is an example of creating objects from a class, and then referecing those objects properties.
*******************/
